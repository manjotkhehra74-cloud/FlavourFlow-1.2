...
function run() {
  ...
  const users = [
    { code: 'UTL0001', name: 'HR Admin', email: 'admin@pulsehr.app', role: 'admin', color: '#1e40af', desig: 'HR Administrator', dept: 'HR', manager: null, phone: '9876500000', bday: '01-26', hire: '2021-01-01' },
    ...
    { code: 'UTL12830', name: 'Deepak Kumar Chauhan', email: 'deepak.c@pulsehr.app', role: 'employee', color: '#ef4444', desig: 'Software Engineer', dept: 'Engineering', manager: 2, phone: '9876500002', bday: '03-22', hire: '2023-09-09' },
    { code: 'UTL12831', name: 'Rajnikant R Rao', email: 'rajni@pulsehr.app', role: 'employee', color: '#7c3aed', desig: 'QA Engineer', dept: 'Engineering', manager: 2, phone: '9876500003', bday: '11-05', hire: '2024-01-12' },
    { code: 'UTL12832', name: 'Deepak Thakur', email: 'deepak.t@pulsehr.app', role: 'employee', color: '#059669', desig: 'Backend Developer', dept: 'Engineering', manager: 2, phone: '9876500004', bday: '05-30', hire: '2023-02-01' },
    { code: 'UTL12833', name: 'Anuj Jain', email: 'anuj@pulsehr.app', role: 'employee', color: '#f59e0b', desig: 'Product Designer', dept: 'Design', manager: 2, phone: '9876500005', bday: '08-19', hire: '2024-08-19' },
    { code: 'UTL12834', name: 'Naresh Sharma', email: 'naresh@pulsehr.app', role: 'employee', color: '#2563eb', desig: 'DevOps Engineer', dept: 'Engineering', manager: 2, phone: '9876500006', bday: '12-01', hire: '2022-05-20' },
    { code: 'UTL12835', name: 'Dharmesh Shah', email: 'dharmesh@pulsehr.app', role: 'employee', color: '#0891b2', desig: 'Frontend Developer', dept: 'Engineering', manager: 2, phone: '9876500007', bday: '07-14', hire: '2024-08-19' },
    { code: 'UTL12836', name: 'Riddhi Patel', email: 'riddhi@pulsehr.app', role: 'employee', color: '#db2777', desig: 'HR Executive', dept: 'HR', manager: 2, phone: '9876500008', bday: '08-19', hire: '2024-08-19' },
  ];
